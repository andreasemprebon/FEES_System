...
PROJECT = FEES_System
# ADS
OBJECTS += ADS/FEESADS.o
# ADS/Propagation
OBJECTS += ADS/Propagation/ADSPropagation.o
OBJECTS += ADS/Propagation/AngularVelocity/ADSPropagationAngularVelocity.o
OBJECTS += ADS/Propagation/BiasSavingLogic/ADSPropagationBiasSavingLogic.o
OBJECTS += ADS/Propagation/Block/ADSPropagationBlock.o
# ADS/DynamicFilter
OBJECTS += ADS/DynamicFilter/ADSDynamicFilter.o
OBJECTS += ADS/DynamicFilter/Kinematic/ADSDynamicFilterKinematic.o
OBJECTS += ADS/DynamicFilter/Observer/ADSDynamicFilterObserver.o
# Sensors
OBJECTS += Sensors/FEESSensors.o
# Math
OBJECTS += Math/FEESMath.o
# Debug
OBJECTS += FEESDebug.o
# Main
OBJECTS += main.o
...
CC_SYMBOLS = -D__MBED__=1 -DDEVICE_I2CSLAVE=1 -DTARGET_LIKE_MBED -DDEVICE_PORTINOUT=1 -DTARGET_RTOS_M4_M7 -DDEVICE_RTC=1 -DTOOLCHAIN_object -D__CMSIS_RTOS -DTOOLCHAIN_GCC -DDEVICE_STDIO_MESSAGES=1 -DDEVICE_CAN=1 -DTARGET_CORTEX_M -DTARGET_LIKE_CORTEX_M4 -DDEVICE_ANALOGOUT=1 -DTARGET_M4 -DTARGET_UVISOR_UNSUPPORTED -DTARGET_STM32L4 -DDEVICE_SERIAL=1 -DTARGET_STM32L476VG -DDEVICE_INTERRUPTIN=1 -DDEVICE_I2C=1 -DDEVICE_PORTOUT=1 -D__CORTEX_M4 -DTARGET_DISCO_L476VG -D__FPU_PRESENT=1 -DDEVICE_PORTIN=1 -DTARGET_RELEASE -DTARGET_STM -DDEVICE_SERIAL_FC=1 -D__MBED_CMSIS_RTOS_CM -DDEVICE_SLEEP=1 -DTOOLCHAIN_GCC_ARM -DMBED_BUILD_TIMESTAMP=1485893783.97 -DDEVICE_SPI=1 -DDEVICE_SPISLAVE=1 -DDEVICE_ANALOGIN=1 -DDEVICE_PWMOUT=1 -DARM_MATH_CM4 
